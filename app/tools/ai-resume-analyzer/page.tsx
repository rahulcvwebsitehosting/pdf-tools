...
export const metadata: Metadata = {
  ...
  keywords: ["free ai resume analyzer","ai resume analyzer online","free ai resume analyzer online","ai resume analyzer tool","client-side ai resume analyzer","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI Resume Analyzer - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-resume-analyzer",
