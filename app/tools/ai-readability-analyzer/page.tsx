...
import FreeAiAiReadabilityAnalyzerTool from "@/components/tools/ai-readability-analyzer";
import { SchemaMarkup } from "@/components/schema-markup";
import { AeoSection } from "@/components/aeo-section";
import { RelatedTools } from "@/components/related-tools";

const toolName = "Free AI Readability Analyzer";
const toolUrl = "/tools/ai-readability-analyzer";
...
export const metadata: Metadata = {
  ...
  keywords: ["free ai readability analyzer","ai readability analyzer online","free ai readability analyzer online","ai readability analyzer tool","client-side ai readability analyzer","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI Readability Analyzer - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-readability-analyzer",
...
const faqs = [
  {
    question: "How to use Free AI Readability Analyzer completely offline?",
...
export default function Page() {
  return (
    <>
      <SchemaMarkup
        toolName="Free AI Readability Analyzer"
      ...
      <main className="min-h-screen bg-background text-foreground">
        <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <FreeAiAiReadabilityAnalyzerTool />
          ...
          <RelatedTools currentSlug="ai-readability-analyzer" category="pdf" />
        </article>
      </main>
    </>
  );
