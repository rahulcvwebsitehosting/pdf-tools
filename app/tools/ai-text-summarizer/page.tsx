...
import FreeAiAiTextSummarizerTool from "@/components/tools/ai-text-summarizer";
import { SchemaMarkup } from "@/components/schema-markup";
import { AeoSection } from "@/components/aeo-section";
import { RelatedTools } from "@/components/related-tools";

const toolName = "Free AI Text Summarizer";
const toolUrl = "/tools/ai-text-summarizer";
...
export const metadata: Metadata = {
  ...
  keywords: ["free ai text summarizer","ai text summarizer online","free ai text summarizer online","ai text summarizer tool","client-side ai text summarizer","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI Text Summarizer - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-text-summarizer",
...
const faqs = [
  {
    question: "How to use Free AI Text Summarizer completely offline?",
...
export default function Page() {
  return (
    <>
      <SchemaMarkup
        toolName="Free AI Text Summarizer"
      ...
      <main className="min-h-screen bg-background text-foreground">
        <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <RelatedTools currentSlug="ai-text-summarizer" category="office" />
        </article>
      </main>
    </>
  );
