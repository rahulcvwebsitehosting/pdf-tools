...
export const metadata: Metadata = {
  title: "Free Excel to PDF Online",
  description: displayDescription,
  keywords: ["free excel to pdf","excel to pdf online","free excel to pdf online","excel to pdf tool","client-side excel to pdf","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free Excel to PDF Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/excel-to-pdf",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
