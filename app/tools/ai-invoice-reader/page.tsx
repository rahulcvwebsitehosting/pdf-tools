...
export const metadata: Metadata = {
  title: "Free AI Invoice Reader - 100% Local | ToolsAtZero",
  description: displayDescription,
  keywords: ["free ai invoice reader","ai invoice reader online","free ai invoice reader online","ai invoice reader tool","client-side ai invoice reader","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI Invoice Reader - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-invoice-reader",
