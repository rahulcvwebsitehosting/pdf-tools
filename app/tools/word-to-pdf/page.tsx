...
export const metadata: Metadata = {
  title: "Free Word to PDF Online",
  description: displayDescription,
  keywords: ["free word to pdf","word to pdf online","free word to pdf online","word to pdf tool","client-side word to pdf","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free Word to PDF Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/word-to-pdf",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
