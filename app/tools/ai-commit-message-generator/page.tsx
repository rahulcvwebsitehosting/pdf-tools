...
const toolUrl = "/tools/ai-commit-message-generator";
...
const faqs = [
  {
    question: "How to use Free AI Commit Message Generator completely offline?",
...
export default function Page() {
  return (
    <>
      <SchemaMarkup
        toolName="Free AI Commit Message Generator"
