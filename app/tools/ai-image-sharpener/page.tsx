...
import FreeAiAiImageSharpenerTool from "@/components/tools/ai-image-sharpener";
import { SchemaMarkup } from "@/components/schema-markup";
import { AeoSection } from "@/components/aeo-section";
import { RelatedTools } from "@/components/related-tools";

const toolName = "Free AI Image Sharpener";
const toolUrl = "/tools/ai-image-sharpener";
...
export const metadata: Metadata = {
  ...
  keywords: ["free ai image sharpener","ai image sharpener online","free ai image sharpener online","ai image sharpener tool","client-side ai image sharpener","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI Image Sharpener - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-image-sharpener",
...
const faqs = [
  {
    question: "How to use Free AI Image Sharpener completely offline?",
...
export default function Page() {
  return (
    <>
      <SchemaMarkup
        toolName="Free AI Image Sharpener"
      ...
      <main className="min-h-screen bg-background text-foreground">
        <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <RelatedTools currentSlug="ai-image-sharpener" category="image" />
        </article>
      </main>
    </>
  );
