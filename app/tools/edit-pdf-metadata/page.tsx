...
export const metadata: Metadata = {
  title: "Free Edit Metadata Online",
  description: displayDescription,
  keywords: ["free edit metadata","edit metadata online","free edit metadata online","edit metadata tool","client-side edit metadata","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free Edit Metadata Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/edit-pdf-metadata",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
