...
export const metadata: Metadata = {
  ...
  keywords: ["free ai colorize photo","ai colorize photo online","free ai colorize photo online","ai colorize photo tool","client-side ai colorize photo","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI Colorize Photo - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-colorize-photo",
