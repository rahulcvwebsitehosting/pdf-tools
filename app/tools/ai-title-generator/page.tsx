...
export const metadata: Metadata = {
  title: "Free AI Title Generator - 100% Local | PDF Tools",
  description: displayDescription,
  keywords: ["free ai title generator","ai title generator online","free ai title generator online","ai title generator tool","client-side ai title generator","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free AI Title Generator - 100% Local | PDF Tools",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/ai-title-generator",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
    ...
    <>
      ...
      <main className="min-h-screen bg-background text-foreground">
        <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <RelatedTools currentSlug="ai-title-generator" category="office" />
        </article>
      </main>
    </>
  );
