...
const toolUrl = "/tools/ai-qr-code-scanner";
const displayDescription = "Use this Free AI qr code scanner tool completely offline in your local browser.";

export const metadata: Metadata = {
  title: "Free AI QR Code Scanner - 100% Local | ToolsAtZero",
  description: displayDescription,
  keywords: ["free ai qr code scanner","ai qr code scanner online","free ai qr code scanner online","ai qr code scanner tool","client-side ai qr code scanner","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI QR Code Scanner - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-qr-code-scanner",
...
const faqs = [
  {
    question: "How to use Free AI QR Code Scanner completely offline?",
...
export default function Page() {
  return (
    <>
      <SchemaMarkup
        toolName="Free AI QR Code Scanner"
