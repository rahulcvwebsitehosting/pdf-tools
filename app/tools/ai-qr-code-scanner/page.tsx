...
export const metadata: Metadata = {
  ...
  keywords: ["free ai qr code scanner","ai qr code scanner online","free ai qr code scanner online","ai qr code scanner tool","client-side ai qr code scanner","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free AI QR Code Scanner - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/ai-qr-code-scanner",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
