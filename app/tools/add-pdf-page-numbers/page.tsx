...
export const metadata: Metadata = {
  title: "Free Add Page Numbers Online",
  description: displayDescription,
  keywords: ["free add page numbers","add page numbers online","free add page numbers online","add page numbers tool","client-side add page numbers","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free Add Page Numbers Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/add-pdf-page-numbers",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
