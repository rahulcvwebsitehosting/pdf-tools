...
export const metadata: Metadata = {
  ...
  keywords: ["free regex tester","regex tester online","free regex tester online","regex tester tool","client-side regex tester","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free RegEx Tester Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/regex-tester",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
