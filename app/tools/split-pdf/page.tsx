...
export const metadata: Metadata = {
  title: "Free Split PDF Online",
  description: displayDescription,
  keywords: ["free split pdf","split pdf online","free split pdf online","split pdf tool","client-side split pdf","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free Split PDF Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/split-pdf",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
