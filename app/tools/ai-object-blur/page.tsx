...
export const metadata: Metadata = {
  title: "Free AI Object Blur - 100% Local | PDF Tools",
  description: displayDescription,
  keywords: ["free ai object blur","ai object blur online","free ai object blur online","ai object blur tool","client-side ai object blur","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free AI Object Blur - 100% Local | PDF Tools",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/ai-object-blur",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
    ...
    <>
      ...
      <main className="min-h-screen bg-background text-foreground">
        <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <RelatedTools currentSlug="ai-object-blur" category="image" />
        </article>
      </main>
    </>
  );
