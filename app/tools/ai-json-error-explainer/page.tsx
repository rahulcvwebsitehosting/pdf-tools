...
import FreeAiAiJsonErrorExplainerTool from "@/components/tools/ai-json-error-explainer";
import { SchemaMarkup } from "@/components/schema-markup";
import { AeoSection } from "@/components/aeo-section";
import { RelatedTools } from "@/components/related-tools";

const toolName = "Free AI JSON Error Explainer";
const toolUrl = "/tools/ai-json-error-explainer";
...
export const metadata: Metadata = {
  ...
  keywords: ["free ai json error explainer","ai json error explainer online","free ai json error explainer online","ai json error explainer tool","client-side ai json error explainer","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI JSON Error Explainer - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-json-error-explainer",
...
const faqs = [
  {
    question: "How to use Free AI JSON Error Explainer completely offline?",
...
export default function Page() {
  return (
    <>
      <SchemaMarkup
        toolName="Free AI JSON Error Explainer"
      ...
      <main className="min-h-screen bg-background text-foreground">
        <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <FreeAiAiJsonErrorExplainerTool />
          ...
          <RelatedTools currentSlug="ai-json-error-explainer" category="developer" />
        </article>
      </main>
    </>
  );
