...
export const metadata: Metadata = {
  ...
  keywords: ["free find & replace","find & replace online","free find & replace online","find & replace tool","client-side find & replace","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free Find & Replace Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/find-replace",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
