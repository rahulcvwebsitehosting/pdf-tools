...
export const metadata: Metadata = {
  ...
  keywords: ["free ai voice activity detector","ai voice activity detector online","free ai voice activity detector online","ai voice activity detector tool","client-side ai voice activity detector","free online tools","privacy first","no upload","browser tool","ToolsAtZero"],
  openGraph: {
    title: "Free AI Voice Activity Detector - 100% Local | ToolsAtZero",
    description: displayDescription,
    url: "https://toolsatzero.com/tools/ai-voice-activity-detector",
