...
export const metadata: Metadata = {
  title: "Free HTML Entity Encoder Online",
  description: displayDescription,
  keywords: ["free html entity encoder","html entity encoder online","free html entity encoder online","html entity encoder tool","client-side html entity encoder","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free HTML Entity Encoder Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/html-entities",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
