...
export const metadata: Metadata = {
  title: "Free Protect PDF Online",
  description: displayDescription,
  keywords: ["free protect pdf","protect pdf online","free protect pdf online","protect pdf tool","client-side protect pdf","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free Protect PDF Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/protect-pdf",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
