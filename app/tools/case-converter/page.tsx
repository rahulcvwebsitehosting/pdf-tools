...
export const metadata: Metadata = {
  title: "Free Advanced Case Converter Online",
  description: displayDescription,
  keywords: ["free advanced case converter","advanced case converter online","free advanced case converter online","advanced case converter tool","client-side advanced case converter","free online tools","privacy first","no upload","browser tool"],
  openGraph: {
    title: "Free Advanced Case Converter Online",
    description: displayDescription,
    url: "https://pdf-tools-cv.vercel.app/tools/case-converter",
    siteName: "PDF Tools",
    type: "website",
  },
  twitter: {
