...
export default function FreeAiAiReceiptScannerTool() {
  ...
  const handleProcess = async () => {
    ...
    if (compiledOcrText && compiledOcrText.trim() && textReady) {
      ...
      const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for parsing OCR receipt data and returning structured key-value transaction metrics. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "Target Store total 10.50" },
    { role: "assistant", content: "- Store: Target\n- Total: $10.50" },
    { role: "user", content: "Walmart Store #123\nDate: 06/20/2026\nApples: $3.00\nMilk: $2.50\nTax: $0.44\nTotal: $5.94" },
    { role: "assistant", content: "- Store: Walmart (#123)\n- Date: 06/20/2026\n- Items:\n  - Apples: $3.00\n  - Milk: $2.50\n- Tax: $0.44\n- Total: $5.94" }
  ];
      generate([
        ...fewShotConfig,
