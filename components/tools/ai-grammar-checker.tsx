...
export default function FreeAiAiGrammarCheckerTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for checking and correcting grammar and syntax issues. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "hello i is good" },
    { role: "assistant", content: "Hello, I am good." },
    { role: "user", content: "she dont like apples because they is sour" },
    { role: "assistant", content: "She doesn't like apples because they are sour." }
  ];
    generate([
      ...fewShotConfig,
