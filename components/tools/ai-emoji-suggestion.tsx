...
export default function FreeAiAiEmojiSuggestionTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for suggesting contextually relevant emojis for a block of text. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "running in the rain" },
    { role: "assistant", content: "🏃‍♂️🌧️☔" },
    { role: "user", content: "Had a great cup of coffee and read a book this morning." },
