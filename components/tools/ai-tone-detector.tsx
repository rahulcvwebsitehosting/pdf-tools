...
export default function FreeAiAiToneDetectorTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for detecting the emotional tone of text. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "hello" },
    { role: "assistant", content: "Neutral" },
    { role: "user", content: "I am absolutely thrilled and ecstatic about our new partnership! This is going to be amazing!" },
    { role: "assistant", content: "Ecstatic / Enthusiastic" }
  ];
    generate([
      ...fewShotConfig,
