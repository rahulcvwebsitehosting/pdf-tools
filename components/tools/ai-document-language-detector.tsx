...
export default function FreeAiAiDocumentLanguageDetectorTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for detecting the language of document text. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "hola amigo" },
    { role: "assistant", content: "Spanish" },
    { role: "user", content: "Dies ist ein vertrauliches Dokument für interne Zwecke." },
