...
export default function FreeAiAiTitleGeneratorTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for generating catchy, SEO-friendly article titles from a text content summary. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "how to wash dishes using soap and warm water" },
    { role: "assistant", content: "How to Wash Dishes: A Simple Step-by-Step Guide" },
    { role: "user", content: "A detailed guide explaining the benefits of running Web Workers in Next.js applications for background tasks." },
    { role: "assistant", content: "Boost React Speed: Master Web Workers in Next.js" }
  ];
    generate([
      ...fewShotConfig,
