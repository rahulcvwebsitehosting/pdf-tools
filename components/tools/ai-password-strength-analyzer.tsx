...
export default function FreeAiAiPasswordStrengthAnalyzerTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for analyzing password entropy and providing a detailed strength evaluation. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "123456" },
    { role: "assistant", content: "Strength: Very Weak (Entropy: low). Hack Time: Instant. Suggestion: Use letters, numbers, and symbols." },
    { role: "user", content: "Tr0ub1e$h00t!ng99" },
    { role: "assistant", content: "Strength: Very Strong. Hack Time: Centuries. Attributes: Length, case variation, digits, symbols." }
  ];
    generate([
      ...fewShotConfig,
