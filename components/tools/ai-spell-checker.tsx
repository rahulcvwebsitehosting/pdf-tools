...
export default function FreeAiAiSpellCheckerTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for checking spelling errors and correcting them. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "teh apple was deliciousss" },
    { role: "assistant", content: "The apple was delicious." },
    { role: "user", content: "i am writing a letter to my freind" },
    { role: "assistant", content: "I am writing a letter to my friend." }
  ];
    generate([
      ...fewShotConfig,
