...
export default function FreeAiAiLanguageDetectorTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for detecting the primary language of the text. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "hello" },
    { role: "assistant", content: "English" },
    { role: "user", content: "Bonjour tout le monde, comment allez-vous aujourd'hui?" },
