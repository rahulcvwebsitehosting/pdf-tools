...
export default function FreeAiAiParaphraserTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for rephrasing text to use different words while keeping the same meaning. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "He ran fast to the store." },
    { role: "assistant", content: "He hurried to the shop." },
    { role: "user", content: "Prioritizing security safeguards protects user credentials from data breaches." },
    { role: "assistant", content: "Focusing on security measures keeps user passwords safe from hackers." }
  ];
    generate([
      ...fewShotConfig,
