...
export default function FreeAiAiSentenceSimplifierTool() {
  ...
  const handleRun = () => {
    ...
    const fewShotConfig = [
    { role: "system", content: "You are a strict, single-purpose utility for simplifying complex sentences into plain, readable versions. Output ONLY the final processed result. Do NOT include greetings, conversational filler, markdown blocks, or explanations." },
    { role: "user", content: "The utilizing of high-complexity vocabulary yields minimal comprehension gains." },
    { role: "assistant", content: "Using complex words does not help people understand better." },
    { role: "user", content: "Notwithstanding the inclement weather patterns currently manifesting, the scheduled event will proceed." },
    { role: "assistant", content: "The event will go on despite the bad weather." }
  ];
    generate([
      ...fewShotConfig,
